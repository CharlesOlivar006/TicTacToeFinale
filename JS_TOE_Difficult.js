...
function getBestMove(emptySquares) {
    ...
    // If none of the above, try to make a strategic move
    // Here, you can implement specific strategies, for example, focusing on diagonal combinations
    // or making a move that blocks the player from forming a winning combination
